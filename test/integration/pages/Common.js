sap.ui.define([
		...
		function getFrameUrl (sHash, sUrlParameters) {
			var sUrl = jQuery.sap.getResourcePath("com/btc/terminal/app", ".html");
		...
		return Opa5.extend("com.btc.terminal.test.integration.pages.Common", {
			...
			getMockServer : function () {
				return new Promise(function (success) {
					Opa5.getWindow().sap.ui.require(["com/btc/terminal/localService/mockserver"], function (mockserver) {
